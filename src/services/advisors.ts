...
type AvailabilityData = { availability_status: AvailabilityStatus; minutes?: number | null }
...
export const advisorsService = {
  ...
  async updateAvailability(_data: AvailabilityData): Promise<{ availability_status: AvailabilityStatus }> {
    throw new Error('NOT IMPLEMENTED — pendiente Tarea 9')
  },
