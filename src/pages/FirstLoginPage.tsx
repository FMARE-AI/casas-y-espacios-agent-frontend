...
export function FirstLoginPage() {
  ...
  return (
    ...
    >
      ...
      <div className="max-w-md w-full relative z-10 bg-bg-secondary border border-border-default rounded-xl p-6 sm:p-8 shadow-md">
        <div className="mb-6">
