      ...
      <div className="max-w-md w-full bg-[#252522] border border-[#3A3A37] rounded-xl p-6 sm:p-8 shadow-2xl">
        <div className="mb-6">
          <h2 className="text-xl font-bold text-white tracking-tight flex items-center gap-2">
            <svg
              className="w-5 h-5 shrink-0 text-[#FFB84D]"
              fill="none"
              stroke="currentColor"
              viewBox="0 0 24 24"
            >
          ...
          <p className="text-xs text-[#8B8FA8] mt-1.5">
            Por motivos de seguridad, debes configurar una contraseña definitiva en tu primer login.
          </p>
        </div>
          ...
          <div>
            <div className="relative">
              ...
              <label
                ...
                className="absolute text-[10px] text-[#8B8FA8] duration-150 top-4 left-3 origin-[0] transform -translate-y-3 scale-75 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-3 peer-focus:text-[#01A4E3] pointer-events-none"
              >
                Nueva Contraseña
              </label>
            </div>
            {errors.newPassword && (
              <span className="text-[10px] text-[#FF5B5B] block mt-1">
